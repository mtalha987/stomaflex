...
const Footer = () => {
  return (
    <>
      <div className="xl:px-[90px] lg:px-10 px-5 lg:mt-[100px] mt-8 bg-light-gray flex flex-col ">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div>
                <form className="flex">
                  ...
                  />
                  <button className="w-[134px] h-12 bg-pink text-white text-base font-normal font-arial ml-2">
                    Shop Now
                  </button>
                </form>
              </div>
