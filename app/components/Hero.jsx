...
const Hero = () => {
  return (
    <>
      <div className="bg-hero-pattern bg-cover bg-center  bg-no-repeat  mt-6">
        <div className="lg:pt-64 sm:pt-28 xs:pt-12 lg:pl-28 sm:pl-10 xs:pl-5">
          <h1 className="text-primary text-[56px] font-normal font-nohemi lg:w-[55%]">
            The Flexible solution for your Stoma needs
          </h1>
          <p className="text-black text-base font-normal font-primary leading-normal mt-5 lg:w-[34%]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore
          </p>
          <div className="mt-10 flex gap-3 pb-56">
